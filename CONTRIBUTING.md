# Contributing to External system mocks

Owning team: @northgate/platform-engineering. Ask in `#platform-engineering` on the internal chat platform before starting anything that
